...
export default function HomeVendor({ navigation }) {
  ...
  const [dishes, setDishes] = useState([
    ...
    { id: 1, name: "Cháo ếch Singapore", price: "50.000đ", status: "Đang bán", numSell: "1000", description: "..." },
    { id: 2, name: "Cháo ếch om", price: "45.000đ", status: "Đang bán", numSell: "500", description: "..." },
    { id: 3, name: "Cháo ếch xào", price: "60.000đ", status: "Đang bán", numSell: "200", description: "..." },
    { id: 4, name: "Cháo ếch chiên", price: "40.000đ", status: "Đang bán", numSell: "300", description: "..." },
    { id: 5, name: "Cháo ếch hấp", price: "55.000đ", status: "Đang bán", numSell: "800", description: "..." },
    { id: 6, name: "Cháo ếch nướng", price: "70.000đ", status: "Đang bán", numSell: "600", description: "..." },
    { id: 7, name: "Cháo ếch xào lăn", price: "80.000đ", status: "Đang bán", numSell: "400", description: "..." },
  ]);
  ...
  const HeaderComponent = () => (
    <>
      <View style={{ gap: 10 }}>
        ...
        <Text style={styles.addressText}>VQCX+Q8M, Phường Linh Trung, Thủ Đức, Hồ Chí Minh</Text>
